...
if __name__ == "__main__":
    # Plain Backtracking on simple CSP
    print("Testing all propagators on simple CSP")
    for prop_name, prop in [("prop_BT", prop_BT), ("prop_FC", prop_FC), ("prop_GAC", prop_GAC)]:
        print(f"\nUsing {prop_name}:")
        csp = simpleCSP
        var_array = [x, y, z, w]
        solver = BT(csp)
    ...
    print("\n=======================================================")
    # Plain Backtracking on 8-queens
    print("Testing all propagators on 8-queens")
    for prop_name, prop in [("prop_BT", prop_BT), ("prop_FC", prop_FC), ("prop_GAC", prop_GAC)]:
        print(f"\nUsing {prop_name}:")
        csp = nQueens(8)
